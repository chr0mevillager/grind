...
function findModule(module: string) {
	...
	results.push(
		new EmbedBuilder()
			...
			.setTitle("<:" + module + ":" + emoji.main[module].id + ">\u2800" + module.charAt(0).toUpperCase() + module.slice(1) + " Module")
...
function findCommand(search: string) {
	...
	results.push(
		new EmbedBuilder()
			...
			.setTitle("<:Search_White:" + emoji.white.search.id + ">\u2800Here are your Results")
	...
	if (results.length > 1) {
		...
		return [
			new EmbedBuilder()
				...
				.setTitle("<:X_White:" + emoji.white.x.id + ">\u2800No Results were Found")
				...
				await interaction.reply({
					embeds: [
						new EmbedBuilder()
							...
							.addFields([
								{
									name: "<:Message:" + emoji.main.message.id + ">\u2800Messages",
								...
								{
									name: "<:Poll:" + emoji.main.poll.id + ">\u2800Polls",
								...
								{
									name: "<:Giveaway:" + emoji.main.giveaway.id + ">\u2800Giveaways",
