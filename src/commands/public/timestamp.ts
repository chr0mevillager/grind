			...
			await interaction.reply({
				...
				embeds: [
					new EmbedBuilder()
						...
						.setDescription("Your timer is set to end on <t:" + time + ">, which is <t:" + time + ":R>.```To copy this timer anywhere, select how you would like it to be displayed, then copy the text below it.```")
						.addFields([
							{
								name: "<t:" + time + ":d>",
								value: "```<t:" + time + ":d>```",
